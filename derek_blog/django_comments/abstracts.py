...
class BaseCommentAbstractModel(models.Model):
    ...
    #site = models.ForeignKey(Site, on_delete=models.CASCADE) #修改前 by May
...
class CommentAbstractModel(BaseCommentAbstractModel):
    ...
    user_email = models.EmailField(_("user's email address"),max_length=254, blank=True,
                                   null=True, default='xxx@xxx.com')
    user_url = models.URLField(_("user's URL"), blank=True,null=True,default='https://xxx.xxx.xxx.xxxx')
    ...
    level = models.PositiveIntegerField(default=0, blank=True, null=True, verbose_name='评论层级')
