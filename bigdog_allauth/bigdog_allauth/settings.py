"""
Django settings for bigdog_allauth project.
...
SECRET_KEY = 'lgu^=b&i&!h@hp)$zc(!&l2fo=5)!^p4w%o#3p1l*x7qbz!o_^'
...
ROOT_URLCONF = 'bigdog_allauth.urls'
...
WSGI_APPLICATION = 'bigdog_allauth.wsgi.application'
